...
//            boolean check = ValidateUtils.expirationDate(timeAction);
    ...
    public Car(String brand, String model, Integer year, Double engineVolume, String color, String country,
               String transmission, String body, String registrationNumber, int numberPlaces, String tyre,
               String remoteStartEngine, String keylessAccess, LocalDate timeAction, double cost, String number) {
    ...
    @Override
    public String toString() {
        return "Марка автомобиля: " + brand + ", модель: " + model + ", год выпуска: " + year + ", объем двигателя: " +
                engineVolume + ", цвет кузова: " + color + ", страна сборки: " + country + ", коробка передач: " +
                transmission + ", тип кузова: " + body + ", регистрационный номер: " + registrationNumber +
                ", количество мест: " + numberPlaces + ", резина: " + tyre;
    }
...
//    }
    ...
    public static String validateTyre(String tyre) {
        ...
        if ((currentDate.getMonthValue() == 11 || currentDate.getMonthValue() == 12 || currentDate.getMonthValue() == 1
                || currentDate.getMonthValue() == 2 || currentDate.getMonthValue() == 3) && tyre.equalsIgnoreCase("летняя")) {
            return "сменить резину на зимнюю";
                ...
                || currentDate.getMonthValue() == 7 || currentDate.getMonthValue() == 8 || currentDate.getMonthValue() == 9
                || currentDate.getMonthValue() == 10) && tyre.equalsIgnoreCase("зимняя")) {
